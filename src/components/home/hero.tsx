...
export default function HeroFormLayout() {
  return (
    <div className="absolute top-[80%] md:top-[unset] md:bottom-0 md:translate-y-1/2 left-1/2 -translate-x-1/2 w-[calc(100%-32px)]   backdrop-blur-xl rounded-3xl shadow-2xl p-6 sm:p-8 lg:p-10 animate-slide-up border border-soft-grey/20">
      ...
      <form>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 mb-6">
          {/* Brand */}
          <div className="group">
            <label className="block text-sm font-semibold text-dark-base mb-2.5">Brand</label>
          ...
          {/* Type */}
          <div className="group">
            <label className="block text-sm font-semibold text-dark-base mb-2.5">Type</label>
            <div className="relative">
              <Car className="absolute left-4 top-1/2 transform -translate-y-1/2 text-slate-teal w-5 h-5 transition-transform group-hover:scale-110" />
              <select className="w-full pl-12 pr-4 py-3.5 border-2 border-soft-grey/50 rounded-xl focus:ring-2 focus:ring-slate-teal focus:border-slate-teal transition-all duration-300 bg-white hover:border-slate-teal/50 text-dark-base font-medium">
          ...
          {/* Price Range */}
          <div className="group">
            <label className="block text-sm font-semibold text-dark-base mb-2.5">Price Range</label>
            <div className="relative">
          ...
          {/* Location */}
          <div className="group">
            <label className="block text-sm font-semibold text-dark-base mb-2.5">Location</label>
            <div className="relative">
          ...
          {/* Start Date */}
          <div className="group">
            <label className="block text-sm font-semibold text-dark-base mb-2.5">Start Date</label>
            <div className="relative">
          ...
          {/* End Date */}
          <div className="group">
            <label className="block text-sm font-semibold text-dark-base mb-2.5">End Date</label>
            <div className="relative">
              <Calendar className="absolute left-4 top-1/2 transform -translate-y-1/2 text-slate-teal w-5 h-5 transition-transform group-hover:scale-110" />
              <input
                type="date"
