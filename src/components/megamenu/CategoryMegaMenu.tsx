...
export default function CategoryMegaMenu({ onClose }: CategoryMegaMenuProps) {
  return (
      ...
      <div className="max-w-[1600px] mx-auto px-6 py-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
          {categories.map((category) => {
            ...
            return (
              <Link
                key={category.id}  href={category.path}
                onClick={onClose}
              ...
              >
                <div className="flex flex-col items-center text-center gap-3">
                  ...
                  <div>
                    <h4 className="font-bold text-primary text-base mb-1 group-hover:bg-gradient-to-r group-hover:from-site-accent group-hover:to-slate-teal group-hover:bg-clip-text group-hover:text-transparent transition-all duration-300">
                      {category.name}
                    </h4>
