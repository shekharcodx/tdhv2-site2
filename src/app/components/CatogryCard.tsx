...
export default function CarCarousel() {
  ...
  return (
    <div className="w-[1312] mx-auto rounded-xl pt-7 relative bg-[#263337]">
  ...
  autoplay={{
    ...
    disableOnInteraction: false, // 👈 keeps autoplay after user clicks arrows
  }}
  loop={true} // 🔁 keeps looping smoothly
