...
const CardCat: FC<CarCardProps> = ({ car }) => {
  return (
   <div className="flex flex-col md:flex-row w-full max-w-[1080px] h-[325.6px] rounded-[12px] border border-[#E5E5E5] hover:border-[#59787C] transition-colors duration-200 overflow-hidden bg-white md:gap-5 relative mx-auto shadow-sm">
        ...
        <div className="flex justify-between items-start gap-4 flex-wrap">
          <div className="flex flex-col gap-1 text-sm text-gray-600 flex-1 min-w-[200px] gap-3">
            <div className="flex items-center gap-2">
              <Image src="/assets/tick.svg" alt="Delivery" width={14} height={14} />
              Free Delivery (7 days+)
            </div>
            <div className="flex items-center gap-2">
              <Image src="/assets/tick.svg" alt="Rental" width={14} height={14} />
              Minimum 3 days rental
            </div>
            <div className="flex items-center gap-2">
              <Image src="/assets/tick.svg" alt="Insurance" width={14} height={14} />
              Insurance included
            </div>
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex flex-col items-start">
              ...
              <div className="flex items-center text-sm text-gray-500 mt-1">
                <Image src="/assets/kilo.png" alt="Daily Mileage" width={14} height={14} />
            ...
            <div className="flex flex-col items-start">
              ...
              <div className="flex items-center text-sm text-gray-500 mt-1">
                <Image src="/assets/kilo.png" alt="Monthly Mileage" width={14} height={14} />
  ...
  <button className="flex items-center justify-center gap-2 px-4 h-10 min-w-[200px] rounded-lg bg-green-50 border border-green-500 text-green-600 text-sm">
    <Image src="/assets/wat.svg" alt="WhatsApp" width={20} height={20} />
    WhatsApp
  </button>
</div>
